...
function randomSwatch(swatchStart) {
	...
	var index = parseInt( paper.random(swatchStart, swatchList.length) );
...
var Atom = function( point, size, color ) {
	...
	var speed = new Point(
		mass.width*paper.random(-3.3, 3.3),
		mass.height*paper.random(-3.3, 3.3)
	);
