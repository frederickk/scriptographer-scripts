...
function Setup() {
	...
	rasters[0] = new PlacedFile( new java.io.File(script.directory+'/images/FTransitionExample_Kant_left.png') );
	rasters[1] = new PlacedFile( new java.io.File(script.directory+'/images/FTransitionExample_Kant_right.png') );
	rasters[2] = new PlacedFile( new java.io.File(script.directory+'/images/FTransitionExample_Husserl_right.png') );
	rasters[3] = new PlacedFile( new java.io.File(script.directory+'/images/FTransitionExample_Husserl_left.png') );
