...
function CheckForKant() {
	...
	if (file.exists()) {
		return new Array('Lorem ipsum', 'Suomi ipsum', 'Bairisch ipsum', 'Veggie ipsum', 'Bacon ipsum', 'Hipster ipsum', '', 'Kant', 'Husserl', 'Thanks');
	}
	else {
		return new Array('Lorem ipsum', 'Suomi ipsum', 'Bairisch ipsum', 'Veggie ipsum', 'Bacon ipsum', 'Hipster ipsum');
	}
}
